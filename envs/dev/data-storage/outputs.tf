# outputs.tf — envs/dev/data-storage (Plan 03-02, Task 1).
#
...
output "media_bucket_name" {
  description = "Name of dev's media S3 bucket."
  value       = module.data_storage.media_bucket_name
}

output "media_bucket_arn" {
  description = "ARN of dev's media S3 bucket."
  value       = module.data_storage.media_bucket_arn
}

output "media_bucket_regional_domain_name" {
  description = "Regional domain name of dev's media S3 bucket."
