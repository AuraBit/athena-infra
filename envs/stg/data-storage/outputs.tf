# outputs.tf — envs/stg/data-storage (Plan 03-02, Task 2).
#
...
output "media_bucket_name" {
  description = "Name of stg's media S3 bucket."
  value       = module.data_storage.media_bucket_name
}

output "media_bucket_arn" {
  description = "ARN of stg's media S3 bucket."
  value       = module.data_storage.media_bucket_arn
}

output "media_bucket_regional_domain_name" {
  description = "Regional domain name of stg's media S3 bucket."
